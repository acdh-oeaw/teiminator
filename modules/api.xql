...
module namespace api="http://www.digital-archiv.at/ns/teiminator/api";
declare namespace rest = "http://exquery.org/ns/restxq";
declare namespace tei = "http://www.tei-c.org/ns/1.0";
import module namespace functx = "http://www.functx.com";
import module namespace app="http://www.digital-archiv.at/ns/teiminator/templates" at "app.xql";
...
declare 
    %rest:GET
    %rest:path("/teiminator/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/teiminator/{$collection}/{$id}/{$format}")
